              ...
              <div className="space-y-8 animate-fade-in-up">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input type="email" className="base-input !bg-system-gray-200/30 text-system-gray-800/60" defaultValue="dev@archon.kr" disabled />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <input type="text" className="base-input !bg-system-gray-200/30 text-system-gray-800/60" defaultValue="Archon Platform" disabled />
                  </div>
